...
export default function Mediapipe() {
  return (
    <div className="bg-[#e0e0e0] relative size-full" data-name="mediapipe 2">
      <p className="-translate-x-1/2 absolute font-['GenRyuMin2_TW:R',sans-serif] leading-[1.2] left-1/2 lowercase not-italic text-[#7b7b87] text-[28px] text-center top-[248px] tracking-[-1px] whitespace-nowrap">warm</p>
      <div className="-translate-x-1/2 absolute font-['GenRyuMin2_TW:R',sans-serif] leading-[1.2] left-[calc(50%+0.5px)] lowercase not-italic text-[#7b7b87] text-[20px] text-center top-[325px] tracking-[-1px] whitespace-nowrap whitespace-pre">
        <p className="mb-0">{`lay your palm flat. `}</p>
        <p className="mb-0">{`raise it to bring warmth. `}</p>
        <p className="mb-0">{`lower it toward cool. `}</p>
        <p>let the color find where this memory lives.</p>
      </div>
