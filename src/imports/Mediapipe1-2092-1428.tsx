...
function Frame() {
  return (
    <div className="-translate-x-1/2 absolute bg-[rgba(163,167,175,0.2)] content-stretch flex gap-[19px] items-center justify-center left-[calc(50%+0.5px)] px-[30px] py-[15px] rounded-[100px] text-[#8c8c8c] top-[940px] whitespace-nowrap">
...
export default function Mediapipe() {
  return (
    <div className="bg-[#e0e0e0] relative size-full" data-name="mediapipe 1">
      ...
      <Frame />
      <p className="-translate-x-1/2 absolute font-['GenRyuMin2_TW:R',sans-serif] leading-[normal] left-[864.5px] not-italic text-[16px] text-[rgba(42,32,24,0.6)] text-center top-[889px] whitespace-nowrap">(grant camera permission to access gesture control. )</p>
    </div>
  );
}