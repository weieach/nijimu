import svgPaths from "./svg-h5bca79tjj";
import imgScreenshot20260308At14335Am1 from "figma:asset/40e7ee53ecb1609253bd3d3a5aac31ee194303a3.png";

function Frame() {
  return (
    <div className="-translate-x-1/2 absolute bg-[rgba(163,167,175,0.25)] content-stretch flex gap-[19px] items-center justify-center left-[calc(50%-0.13px)] px-[30px] py-[15px] rounded-[100px] top-[916px]">
